...
/**
 * @ORM\Entity(repositoryClass=EncounterTypeRepository::class)
 */
class EncounterType
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=Encounter::class, mappedBy="type")
     */
    private $encounters;
