...
class DepartmentController extends AbstractController
{
    ...
    public function index(PaginatorInterface $paginator, Request $request,DepartmentRepository $departmentRepository): Response
    {

        $queryBuilder =  $departmentRepository->getQuery($request->query->get('search'));
